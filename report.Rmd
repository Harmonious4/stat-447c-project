...
Finally, the overall mean temperature for Vancouver Harbour is estimated to be 11.8 degrees Celsius as of 2025 (95% credible interval [11.6, 12.1]), and the mean temperature in Vancouver is estimated to be currently increasing by 0.027 degrees Celsius per year, with 95% credible interval [0.015, 0.039].
...
mcmc_trace(fit, pars = "max_day") + theme_minimal()
```
